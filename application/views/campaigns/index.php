    ...
    <div class="col-sm-12">
        <div class="panel panel-default panel-table">
            ...
            <div class="panel-heading row">
                ...
                <div class="col-sm-6">
                    <button data-toggle="modal" data-target="#mod-primary" type="button" class="btn btn-primary"><span class="s7-plus"></span> Nuevo</button>
                </div>
            </div>
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading panel-heading-divider">Nueva Campaña</div>
                                <div class="panel-body">
                                    <form name="formNewCampaign" id="formNewCampaign" method="POST">
                                        ...
                                        <div class="form-group row">
                                          <label class="col-3 col-form-label text-right">Fecha de inicio</label>
                                          <div class="col-9">
                                              <input type="datetime" name="fecInicio" id="fecInicio" required class="form-control">
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-3 col-form-label text-right">Fecha de termino</label>
                                            <div class="col-9">
                                                <input type="text" name="fecFin" id="fecFin" required class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <select name="estCampaign" id="estCampaign" required class="form-control custom-select">
                                                    <option value="" selected>Seleccione estado de campaña</option>
                    ...
                    <div class="mt-6">
                        ...
                        <button type="button" name="btnNewCampaign" id="btnNewCampaign" class="btn btn-sm btn-space btn-primary">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
